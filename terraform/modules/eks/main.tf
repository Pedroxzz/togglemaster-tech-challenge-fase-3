...
resource "aws_eks_cluster" "this" {
  ...
  role_arn = var.lab_role_arn != "" ? var.lab_role_arn : aws_iam_role.cluster.arn
...
resource "aws_iam_role_policy_attachment" "node_group_ec2_container" {
...
resource "aws_eks_node_group" "this" {
  ...
  node_role_arn   = var.lab_role_arn != "" ? var.lab_role_arn : aws_iam_role.node_group.arn
  ...
  depends_on = [
    ...
    aws_iam_role_policy_attachment.node_group_ec2_container
  ]
}
